...
$(document).ready(function() {  
	...
	$('#example').DataTable( {
        "ajax": "http://localhost:8081/ExpenseManager/expenses?category=All&startDate="+formatDate(startDate)+"&endDate="+formatDate(endDate)+"",
        "columns": [
        	{ "data": "date" },
        	{ "data": "time" },
        	{ "data": "category" },
...
<div class="form-group">
    <div class="drop-down">
<select name="category" class="form-control"  style="width: 160px; margin-left:80px" id="category" required>
...
<div class="form-group">
    ...
    <h2></h2>
<table id="example" class="display" cellspacing="0" style="margin-left:80px" width="75%">
        <thead>
            <tr>
            	<th>Date</th>
                <th>Time</th>            
